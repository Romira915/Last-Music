...
import { RepeatMode, ShuffleMode } from "../../components/AudioPlayer/audioController";
...
export const { setVolume, setMuted, setRepeatMode, setShuffleMode } = audioPlayerSettingsSlice.actions;
